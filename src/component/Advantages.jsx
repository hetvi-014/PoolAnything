...
const Advantages = () => {
  return (
    <div className='py-12 bg-gradient-to-b from-pink-500 to-purple-500'>
      <div className='flex justify-center'>
        <div className='flex flex-col items-center bg-white rounded-lg p-6 mx-4 max-w-xs'>
          <svg
          ...
          <div className='mt-4 text-purple-600 font-bold text-center'>
        ...
        {/* Repeat the above structure for other advantages */}
      </div>
    </div>
  );
};
